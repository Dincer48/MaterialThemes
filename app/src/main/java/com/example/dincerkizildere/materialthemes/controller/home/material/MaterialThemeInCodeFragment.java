package com.example.dincerkizildere.materialthemes.controller.home.material;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.fragment_material_theme_button_snackbar_blue_theme:
                Resources.Theme blueTheme = new ContextThemeWrapper(v.getContext(), R.style.AppTheme_Blue).getTheme();
